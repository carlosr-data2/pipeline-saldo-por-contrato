...
A pergunta desta ADR: o que um pipeline deve fazer com um problema **real** que
o contrato **não pediu** para tratar?
...
3. **A pergunta volta ao data owner com evidência**: "83% dos lançamentos têm
   ...
   virar regra?" — registrada como uma das dúvidas formais de contrato (P5.2).

## Alternativas rejeitadas

**1. Promover a coerência a regra de bloqueio.** O efeito prático: 83% do
dataset na quarentena — o fechamento nunca aconteceria. Pior que o dano, o
princípio: seria o pipeline **inventando uma regra** que o contrato não pediu, e
com efeito devastador. Regra de qualidade nasce de acordo com o owner, não de
iniciativa unilateral do engenheiro.
