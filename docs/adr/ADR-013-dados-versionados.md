...
avaliador**: `git clone && make demo` funcionando sem nenhum passo extra — ou
...
dependência de ferramenta no clone do avaliador (quem não tem LFS instalado
