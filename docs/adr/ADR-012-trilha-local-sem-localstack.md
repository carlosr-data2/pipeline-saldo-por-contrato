...
## Contexto
A demonstração local não pode depender de rede/conta AWS. E cabe perguntar
explicitamente pelo equivalente local do Glue Data Catalog.
...
## Consequências
A demo é determinística e offline; a AWS vira evidência
