...
## Contexto: performance não decide esta escolha

O projeto admite PySpark ou Scala, e a escolha precisa de justificativa. A
discussão clássica ("Scala é mais rápida porque o Spark é JVM") esconde o que
decide a questão: com a API DataFrame, o código Python e o código Scala geram o
...
linguagem é de ergonomia e manutenção, não de velocidade.
...
**Scala.** Ganharia em três cenários, nenhum presente aqui: uma UDF
