...
certa em outro cenário: upsert **por chave sem partição de negócio**, como uma
dimensão de cadastro ou um CDC de clientes. Nota de evolução: os *deletion
...
- **Reprocessamento em cadeia**: como o snapshot de D+1 depende do de D,
  ...
  **guarda de continuidade**: se existe dia publicado no Silver sem snapshot
  ...
  por cima de um buraco faria o movimento daquele dia sumir do saldo sem
  deixar rastro.
